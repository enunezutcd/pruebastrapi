...
using Autofac;
using Carter;
using ssoStrapi.Api.Plumbing.Config.Converters;
using ssoStrapi.Api.Plumbing.Core;
using Enee.Core.Data.EFCore;
using ssoStrapi.Data;
using ssoStrapi.Domain.Modules.Almacen;
using ssoStrapi.Domain.Modules.Almacen.Aggregates;
...
namespace ssoStrapi.Api.Plumbing.Config;
